...
class HighchartsWidget extends CWidget {
	...
	protected function registerScripts($id, $embeddedScript) {
		...
		$scriptFile = YII_DEBUG ? '/highcharts.src.js' : '/highcharts.src.js';
        $scriptFile1 = YII_DEBUG ? '/highcharts-more.js' : '/highcharts-more.js';
		$cs = Yii::app()->clientScript;
		$cs->registerCoreScript('jquery');
		$cs->registerScriptFile($baseUrl . $scriptFile);
        $cs->registerScriptFile($baseUrl . $scriptFile1);
